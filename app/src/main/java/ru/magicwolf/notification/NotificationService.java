...
public class NotificationService extends BroadcastReceiver {
    ...
    Intent intent;
    //Сервис будет загружать данные и создавать уведомления, необходио убрать код этих действий из других классов
    ...
    private void startNextAlarms(List<UsersDrug> listUsersDrug, Context context) {
        ...
        for (int i = 0; i <= listUsersDrug.size() - 1; i++) {
            ...
            Intent intent = new Intent(context, NotificationReceiver.class).putExtra("wayOfUsing", wayOfUsing).putExtra("drugName", name);
